<div id="card-container" class="card my-5 mx-auto w-75 h-75 rounded-lg shadow-lg">
    <div class="card-header">
        <i class="far fa-user-circle"></i> Connexion client
    </div>
        ...
        <form method="post" class="needs-validation" novalidate>
            <div class="form-group">
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text" id="login"><i class="far fa-user"></i></span>
                    </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input name="phone" type="tel" class="form-control" id="phone" aria-describedby="inputGroupPrepend"
                           required>
                </div>
            </div>
