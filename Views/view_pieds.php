      ...
      <div class="modal fade" id="modalLangue" tabindex="-1" role="dialog" aria-labelledby="modal" aria-hidden="true">
          ...
          <div class="modal-content" id="modalContent">
              <div class="modal-header">
                  <h5 class="modal-title" id="modalTitle"><i class="fas fa-cog"></i> Langue</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                  </button>
              </div>
              <div class="modal-body">
                  ...
                  <div class="navbar-brand input-group d-inline-flex">
                      <div class="input-group-prepend">
                          <label class="input-group-text" id="labelLangue" for="langue"><i class="fas fa-adjust"></i></label>
                      </div>
                      <select class="custom-select" name="langue" id="langue">
                          <option value="clair">English</option>
                          <option value="sombre">French</option>
                      </select>
                  </div>
              </div>
              <div class="modal-footer">
    ...
    <div class="modal fade" id="modalConnexion" tabindex="-1" role="dialog" aria-labelledby="modal" aria-hidden="true">
        ...
        <div class="modal-content" id="modalContent">
            ...
            <div class="modal-body">
                ...
                <div class="navbar-brand input-group d-inline-flex">
                    <div class="input-group-prepend">
                        <label class="input-group-text" id="labelConnexion" for="langue"><i class="fas fa-adjust"></i></label>
                    </div>
                    <select class="custom-select" name="langue" id="langue">
                        <option value="clair">English</option>
                        <option value="sombre">French</option>
  ...
  <div class="modal fade" id="modalInscription" tabindex="-1" role="dialog" aria-labelledby="modal" aria-hidden="true">
      ...
      <div class="modal-content" id="modalContent">
          ...
          <div class="modal-body">
              ...
              <div class="navbar-brand input-group d-inline-flex">
                  <div class="input-group-prepend">
                      <label class="input-group-text" id="labelInscription" for="langue"><i class="fas fa-adjust"></i></label>
                  </div>
                  <select class="custom-select" name="langue" id="langue">
                      <option value="clair">English</option>
                      <option value="sombre">French</option>
